...
//JR: Publish CAR 1 data as separate message
var deviceId2 = settings.iot_deviceSet[1].deviceId;
var token2 = settings.iot_deviceSet[1].token;
...
//JR: Publish CAR 1 data as separate message
var iot_password2 = token2;
var iot_clientid2 = "d:" + settings.iot_deviceOrg + ":" + settings.iot_deviceType + ":" + deviceId2;
...
//JR: Publish CAR 1 data as separate message
var client2 = mqtt.createClient(1883, iot_server, { clientId: iot_clientid2, username: iot_username, password: iot_password2 });
...
var telemetryTopic2 = "iot-2/evt/car1telemetry/fmt/json";
...
//	this.name = "Car " + id + suffix;
	...
	this.speed = null;
	this.state = "normal";
	this.description = "Car id: " + this.name;
	this.type = "car";
	this.doors = "unlocked";
	this.customProps = {
//		turnSignal: "OFF"
//		doors: "unlocked", fuelTank: "full", turnSignal: "off", wipers: "off"
//OK	doors: "unlocked", fuelTank: "full", wipers: "off"
		fuelTank: "full", wipers: "off"
	},
...
//JR: Publish CAR 1 data as separate message
	payload.push(vehicles[0].getPublishPayload());
	client2.publish(telemetryTopic2, JSON.stringify(payload[0]));
}
...
//							{"latitude": "30.26852", "longitude": "-97.74560"}
							...
							{"latitude": "60.166239", "longitude": "24.945059"},
							{"latitude": "60.166559", "longitude": "24.950423"},
							{"latitude": "60.163143", "longitude": "24.950767"},
							{"latitude": "60.163036", "longitude": "24.945145"}
