	...
	this.sub = new Subscription(topic, (function(ctx) {
		return function(message) {
			...
			for (var i in data_array) {
				...
				ctx.objects[data.id].doors = data.doors;
...
function MapObject(id) {
	...
	this.description = "I am connected";
...
MapObject.prototype.getPopoverData = function() {
	...
	data.left.content += '<div><b>Doors:</b> <span class="value" id="status_doors">'+this.doors+'</span></div><hr>';
...
MapObject.prototype.updatePopoverData = function() {
	...
	$("#status_doors").html(status_doors);
}
